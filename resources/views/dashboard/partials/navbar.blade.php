  ...
  <div class="container">
    ...
    <div class="az-header-menu">
      ...
      <ul class="nav">
        ...
        <li class="nav-item">
          <a href="/dashboard/laporan-belanja-gudang" class="nav-link"><i class="far fa-clipboard pr-2"></i>Laporan Gudang</a>
        </li>
        <li class="nav-item">
          <a href="" class="nav-link with-sub"><i class="icon ion-md-paper pr-2"></i>Laporan Outlet</a>
          <nav class="az-menu-sub">
            <a href="/dashboard/laporan-penjualan-margonda" class="nav-link">Outlet Margonda</a>
